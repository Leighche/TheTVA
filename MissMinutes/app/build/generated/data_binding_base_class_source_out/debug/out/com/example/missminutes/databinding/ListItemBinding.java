...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull CardView rootView, @NonNull TextView categoryName,
      @NonNull TextView description, @NonNull TextView endDate, @NonNull TextView labelCategory,
      @NonNull TextView labelDescription, @NonNull TextView labelEndDate,
      @NonNull TextView labelMaxGoal, @NonNull TextView labelMinGoal,
      @NonNull TextView labelStartDate, @NonNull TextView labelTaskName, @NonNull TextView maxGoal,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((CardView) rootView, categoryName, description, endDate,
          labelCategory, labelDescription, labelEndDate, labelMaxGoal, labelMinGoal, labelStartDate,
          labelTaskName, maxGoal, minGoal, objective, startDate, taskImage);
    }
